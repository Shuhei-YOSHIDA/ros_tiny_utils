/**
 * @file fixed_state_broadcaster.cpp
 */
...
void FixedStatePublisher::addChildren(const KDL::SegmentMap::const_iterator segment)
{
...
void FixedStatePublisher::publishTransforms(const map<string, double>& joint_positions, const Time& time, const std::string& tf_prefix)
{
...
void FixedStatePublisher::publishFixedTransforms(const std::string& tf_prefix, bool use_tf_static)
{
